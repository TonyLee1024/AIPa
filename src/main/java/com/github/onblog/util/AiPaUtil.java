...
public class AiPaUtil {
    ...
    private String fileName;// UA


    public AiPaUtil() {
    }

    public AiPaUtil(Charset charset, Map<String, String> header, Connection.Method method, int timeout, String userAgent, Map<String,String> cookies,String fileName,com.lowagie.text.Document document) {
