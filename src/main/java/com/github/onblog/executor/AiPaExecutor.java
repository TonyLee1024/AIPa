...
public class AiPaExecutor {
     ...
     * @param list List集合
     */
    public void submit(List<String> list,String fileName,com.lowagie.text.Document document) {
        for (int i = 0; i < list.size(); i++) {
            futureList.add(executor.submit(new AiPaCallable().init(aiPaWorker, maxFailCount, list.get(i), charset, header, method, timeout, userAgent, cookies,fileName,document)));
        }
    }
